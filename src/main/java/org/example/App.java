...
public class App extends Application {
    ...
    public static void resetLists() throws IOException {
        ...
        componentCollection.add(new GraphicCard ("Geforce RTX 2060 8GB vRAM","ASUS",100,5499.00,8,"DDR6",1605));
        componentCollection.add(new GraphicCard("Radeon RX 5500 8GB vRAM","Sapphire",200,3299.00,8,"DDR6",1300));
        componentCollection.add(new CPU("Core i7 3.6GHz","Intel",100,5199.99,8,3.60, "LGA-1151"));
        componentCollection.add(new CPU("Core i5 3.2GHz","Intel",100,3299.00, 8, 3.20, "LGA-1151"));
        componentCollection.add(new CPU("Ryzen 9 3900X 3.8GHz", "AMD", 105,5190.00,24,3.80, "AM4"));
        ...
        componentCollection.add(new RAM("ValueRam 2x4GB","Kingston",635.00,8,"DDR3",1));
        componentCollection.add(new RAM("Vengance LPX 2x8GB", "Corsair", 1260.00, 16,"DDR4",2));
        componentCollection.add(new Storage("KC2000 250GB SSD","Kingston",882.00,"SSD",250,"GB"));
        componentCollection.add(new Storage("Mobile Black 1TB HDD", "WD",807.00,"HDD",1,"TB"));
